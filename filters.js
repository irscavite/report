import { monthNames } from "./constants.js?v=20260527statuscols";
...
export function applyFilters() {
    ...
    const selectedStatus = document.getElementById('f-status')?.value || 'ALL';
    ...
    document.querySelectorAll('#table-body tr').forEach(tr => {
        ...
        const remarksText = tr.cells[18].innerText.toUpperCase();
        ...
        const matchStatus = selectedStatus === 'ALL' || statusText.toUpperCase().includes(selectedStatus.toUpperCase());

        if (!(matchCntr && matchStatus && matchRemarks && matchDate && matchDuration)) {
...
export function clearFilters() {
    ...
    document.getElementById('f-field-type').value = "7";
